...
console.log("Telegram.WebApp.ready: start");
Telegram.WebApp.ready();
console.log("Telegram.WebApp.ready: end");
 ...
 // URL сервера
const SERVER_URL =  Telegram.WebApp.initDataUnsafe ?  'https://0d14-95-24-20-127.ngrok-free.app' : "http://localhost:5000"; // ОБНОВИТЕ ЭТОТ URL
...
async function getFiles(){
  console.log("getFiles: start")
    ...
    const receivedList =  await getReceivedFiles();
     console.log("getFiles: uploadedList", uploadedList)
     console.log("getFiles: receivedList", receivedList)
     if (uploadedList) {
...
async function ignoreDocument(index) {
 ...
 function openTab(evt, tabId) {
  ...
  console.log("script.js: DOMContentLoaded event listener start");
 document.addEventListener('DOMContentLoaded', () => {
    initializeUserProfile();
    });
 console.log("script.js: DOMContentLoaded event listener end");